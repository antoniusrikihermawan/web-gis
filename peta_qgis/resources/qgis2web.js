...
map.getView().fit([12536898.653993, -891032.605239, 12539996.828557, -889458.279954], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Persebaran Fasilitas Kesehatan Kelurahan Klojen Kota Malang</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (336 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta tematik ini menyajikan persebaran fasilitas kesehatan di Kelurahan Klojen, Kota Malang, yang meliputi rumah sakit, puskesmas, klinik, dan apotek. Peta dibuat menggunakan QGIS untuk memberikan informasi spasial mengenai distribusi dan aksesibilitas fasilitas kesehatan sebagai pendukung perencanaan dan pelayanan kesehatan wilayah. ';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_LokasiFakesKlojen_13,
    colName: 'Nama',
    zoom: 10,
    collapsed: true,
    map: map,
